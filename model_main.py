...
def main(argv):
    ...
    eval_input_fns = train_and_eval_dict['eval_inputs_fns']
    eval_on_train_input_fn = train_and_eval_dict['eval_on_train_fn']
    ...
    if FLAGS.run_once:
        ...
        train_spec, eval_spec = model_lib.creae_train_and_eval_specs(
            train_input_fn,
            eval_input_fns,
            predict_input_fn,
            train_steps,
